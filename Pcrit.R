...
muus.pc=read.presens("tbocto 1000 pcrit tank 3 and 4 8-11-21-ch3.txt")

plot(muus.pc$O21,type="l",ylim=c(0,280))
points(muus.pc$O22,col="red",type="l")

##to trim to usable data
muus.pc=muus.pc[50:1900,]

muus.resp=resp.closed(muus.pc,volume=.5,weight=46.1,smooth=30,channel = 2)
