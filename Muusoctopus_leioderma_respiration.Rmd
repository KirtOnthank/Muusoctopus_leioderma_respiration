...
predictions=data.frame(
  day=c(1,7,1,7),
  mass.log=log(rep(log(21.6),4)),
  pco2=as.factor(c(1000,1000,1800,1800))
)

predict(routine.lme,newdata=predictions,level=0)
...
```
```{r}
emmeans(routine.lme,~pco2+day+mass.log)
```
...
predict(routine.lme,newdata=data.frame())

exp(predict(routine.lme,newdata = df1.1800[65,],level=0))
```
